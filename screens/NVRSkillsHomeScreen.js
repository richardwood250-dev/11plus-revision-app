    ...
    const renderStrand = (strand) => {
        return (
            <TouchableOpacity 
                ...
                onPress={() => navigation.navigate('NVRStrand', { strandId: strand.id, strandTitle: strand.title, strandColor: strand.color })}
            >
                ...
                <View style={styles.strandAction}>
                    <Text style={[styles.enterBtn, { color: strand.color }]}>Train ></Text>
                </View>
            </TouchableOpacity>
        );
    };
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingBottom: 20,
        backgroundColor: Colors.green, // NVR theme
    },
    backBtn: {
        paddingVertical: 10,
        paddingRight: 15,
